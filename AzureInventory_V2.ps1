...
#            Date: August 13, 2018                                                                     
#          Author: Alex Sarno, Omer Shaik, Doug Peterson
#            

DESCRIPTION:
This script will pull the infrastructure details of the Azure subscriptions. Details will be stored under the folder "c:\AzureInventory_V2"
